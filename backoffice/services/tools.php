...
use App\Core\CRUD\Herramientas;
use App\Core\Box\Tools;

require_once '../App/Core/CRUD/Tools.php';
...
{
    $target_dir = "../assets/img/herramientas/";
...
function update()
{
    ...
    $serviceManager = new Herramientas();
...
function create()
{
    ...
    $service_data[1] = filter_input(INPUT_POST, 'subtitulo', FILTER_SANITIZE_STRING);
    $service_data[2] = filter_input(INPUT_POST, 'imagen', FILTER_SANITIZE_STRING);
    $service_data[3] = filter_input(INPUT_POST, 'texto_boton', FILTER_SANITIZE_STRING);
    $service_data[4] = filter_input(INPUT_POST, 'url_boton', FILTER_SANITIZE_STRING);
    $qres = $serviceManager->createTools($service_data);
